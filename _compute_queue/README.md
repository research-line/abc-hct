...
1. `qb3_wiedemann_80224_raw_2026-05-23.json`
   ...
   - **Wieder pending seit Loop 351.**
   - Nutzt explizit `--module-base-ring finite --bal-mode sign0-finite`.
   - Deferiert zusätzlich, solange ein manueller
     `mstar_h3a_qb3_wiedemann_production.sage`-Lauf lebt.
2. `qb3_wiedemann_80224_anc_2026-05-23.json`
   - gleiche Zertifizierung für `80224/anc`.
   - Läuft erst nach erfolgreichem raw und nutzt dieselbe finite-field-Route.

Der manuell gestartete Mac-Lauf
`mstar_h3a_qb3_wiedemann_production_remod_q5077_80224_raw_mac_2026-05-24`
darf weiterlaufen. Die Queue startet keinen zweiten Q_B-Wiedemann-Lauf,
solange dieser Prozess lebt.

Wichtig: Der alte rationale Modus `--bal-mode sign0-rational` ist nur noch
für kleine Regressionen oder explizite Diagnostik gedacht. Für Großlevel ist
er wegen rationaler IML/GMP-Nullspace-Rechnung gesperrt.
