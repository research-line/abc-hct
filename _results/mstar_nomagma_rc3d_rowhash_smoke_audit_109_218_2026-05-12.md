...
| Level | Mode | Sign | ncols | Source rows | Recomputed rank | Bound rows | Checks | Manifest |
|---:|---|---:|---:|---:|---:|---:|---|---|
| 109 | raw | 1 | 27 | 27 | 27 | 27 | ok | `manifest.json` |
| 109 | anc | 1 | 27 | 27 | 27 | 27 | ok | `manifest.json` |
| 218 | raw | 1 | 83 | 83 | 83 | 83 | ok | `manifest.json` |
| 218 | anc | 1 | 83 | 83 | 83 | 83 | ok | `manifest.json` |
